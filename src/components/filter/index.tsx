...
const Filter = ({ close }: { close: () => void }) => {
  ...
  return (
    <div className="max-lg:fixed max-lg:inset-0 z-10 max-lg:bg-zinc-900 max-lg:bg-opacity-60 backdrop-blur-sm grid place-items-center">
      <div className="max-lg:max-w-lg max-lg:h-[90vh]  max-lg:min-w-[380px] lg:w-full">
        ...
        <form className="max-lg:p-5 bg-gray h-screen flex flex-col gap-2 rounded-b-md">
